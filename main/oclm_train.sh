...
echo "CH_BEFORE"
echo ------------------
gen_machine/./ch_before_gen.sh ${ch_sym}

# LENGTH MACHINE
echo ------------------
echo "LENGTH MACHINE"
echo ------------------
gen_machine/./length_machine_gen.sh ${ch_sym} $sigma
...
#  exit
  ...
  gen_machine/./ltr2wrd_gen.sh iv_lex.txt ${wd_sym} ${ch_sym} iiv_lex 
  ...
  gen_machine/./ltr2wrd_unk.sh ov_lex.txt ${wd_sym} ${ch_sym} unk_ltr_lm_trans_lex 
  ...
  gen_machine/./ltr2wrd_gen.sh trail.txt ${wd_sym} ${ch_sym} trailing_lex 
